...
function Navbar() {
  ...
  return (
    <header className="sticky top-2 z-50 bg-gradient-to-r from-[#1a1a1a] to-[#000000] text-[#ced4da] px-4 sm:px-6 md:px-6 shadow-md laptop:mx-7 rounded-xl mx-2">
      ...
      >
        <Link to="/" onClick={() => setMenuOpen(false)} className="block hover:text-white transition hover:bg-[#1a1a1a] p-2 rounded-md text-center">Home</Link>
        <Link to="/Products" onClick={() => setMenuOpen(false)} className="block hover:text-white transition hover:bg-[#1a1a1a] p-2 text-center rounded-md">Products</Link>
        <Link to="/devices" onClick={() => setMenuOpen(false)} className="block hover:text-white transition hover:bg-[#1a1a1a] p-2 text-center rounded-md">Smart Watches</Link>
        <Link to="/news" onClick={() => setMenuOpen(false)} className="block hover:text-white transition hover:bg-[#1a1a1a] p-2 text-center rounded-md">Accessories</Link>
        <div>
