  ...
  return (
    <div className="container mx-auto p-4 my-10 flex flex-col md:flex-row md:space-x-10">
      ...
      <div className="flex-1 mt-6 md:mt-0">
        ...
        <p className="text-gray-400 mb-2">Color: <span className="text-white font-medium">{product.color}</span></p>
        <p className="text-gray-400 mb-2">Features: <span className="text-white font-medium">{product.feature}</span></p>
